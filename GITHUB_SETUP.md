...
3. Fill in:
   - **Repository name**: `T19_mlse_project` ⚠️ **IMPORTANT: Must match submission requirements**
   ...
   - **Visibility**: **PUBLIC** ⚠️ **Must be PUBLIC for submission**
...
```bash
git remote add origin https://github.com/YOUR_USERNAME/T19_mlse_project.git
git branch -M main
